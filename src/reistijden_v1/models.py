...
class TrafficFlowCategoryCount(models.Model):
    """
    The number of counted vehicles in a specific vehicle category.
    """

    travel_flow = models.ForeignKey('TrafficFlow', on_delete=models.CASCADE)
...
class TravelTime(models.Model):
    ...
    # num_input_values_used = models.IntegerField(null=True, help_text=(
