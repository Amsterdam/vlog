...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('reistijden_v1', '0012_remove_individualtraveltime_old_vehicle_category'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference_id', models.CharField(help_text='The measuremenetsitereference element describes the measurement site (section or trajectory) against which the values are reported', max_length=255)),
